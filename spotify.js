...
const EndpointGetCurrentlyPlaying = 'https://api.spotify.com/v1/me/player/currently-playing'
...
exports.getCurrentlyPlaying = async function getCurrentlyPlaying() {
  ...
  const resp = await fetch(`${EndpointGetCurrentlyPlaying}?time_range=short_term`, {
    headers: {
